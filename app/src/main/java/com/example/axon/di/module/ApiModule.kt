...
import com.example.axon.BuildConfig
...
import com.example.axon.usecases.repository.remote_data_source.RepositoryRemoteDataSourceImpl
import com.example.axon.usecases.repository.remote_data_source.communicator.ApiService
...
class ApiModule {
    ...
    companion object {
        private val API_URL = "https://randomuser.me/"
    }
    ...
    @Provides
    @ApiScope
    fun providesFeedRemoteDataSource(serverCommunicator: ServerCommunicator): UserRemoteDataSource {
